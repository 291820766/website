...
export const metadata: Metadata = getMetadata({
  ...
  description:
    "Learn about Guangzhou Boying Garment Co Ltd, an OEM ODM garment manufacturer in China serving fashion brands, wholesalers, private label buyers, and custom buyers.",
  path: "/about",
});

const factoryStrengths = [
  "Focused experience in outerwear and fashion garment development for export business.",
  "Support for both OEM production and ODM development according to different buyer needs.",
  "Factory-side coordination covering sampling, production planning, inspection, and delivery follow-up.",
  "Professional communication that helps overseas buyers manage approvals, comments, and timelines more efficiently.",
];
      ...
      <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <h1 className="mt-4 font-serif text-5xl leading-none text-[var(--navy)] md:text-6xl">
            A China garment manufacturer built for reliable development, disciplined production, and long-term B2B cooperation.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-[var(--muted)]">
            Guangzhou Boying Garment Co Ltd is an OEM ODM garment manufacturer
            based in Guangzhou, China. We focus on the development and
            production of down jackets, wool coats, windbreaker jackets, and
            fashion dresses for international fashion buyers.
          </p>
          <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--muted)]">
            We work with fashion brands, wholesalers, private label buyers, and
            custom buyers who need a supplier that understands product details,
            manages production carefully, and communicates in a professional and
            efficient way.
          </p>
          <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--muted)]">
      ...
      <section className="mt-16 grid gap-8 rounded-[2rem] border border-[var(--line)] bg-[var(--navy)] p-8 text-white lg:grid-cols-[1fr_0.9fr] lg:p-10">
        <div>
          ...
          <h2 className="mt-3 max-w-3xl font-serif text-4xl leading-tight md:text-5xl">
            Built to support overseas buyers who need both fashion product capability and dependable factory execution.
          </h2>
          <p className="mt-4 max-w-3xl text-base leading-8 text-stone-300 md:text-lg">
            ...
            about organizing development properly, controlling workmanship,
            keeping quality standards clear, and helping buyers move bulk orders
